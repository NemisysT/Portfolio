      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 justify-items-center">
        ...
        <div className="w-full relative max-w-xs">
          ...
          <div className="relative shadow-xl bg-gray-900 border border-gray-800 px-4 py-8 h-full overflow-hidden rounded-2xl flex flex-col justify-between items-start">
            ...
            <h1 className="font-bold text-xl text-white mb-4 relative z-50">Team Player</h1>
            <p className="font-normal text-base text-slate-500 mb-4 relative z-50">
            An active contributor to student clubs like <span className="text-white font-medium">ByteXync</span>, <span className="text-white font-medium">Power30</span>, and <span className="text-white font-medium">OS Code</span>.  
            I collaborate with peers on technical initiatives. 
            </p>
